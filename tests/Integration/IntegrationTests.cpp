...
URM_TEST(TestInvalidResourceTuning, {
    ...
    std::string validResourceName = "/run/urm/tests/nodes/scaling_min_freq.txt";
...
URM_TEST(ResourceLogicalToPhysicalTranslationVerification1, {
    std::string testResourceName = "/run/urm/tests/nodes/target_test_resource2.txt";
...
URM_TEST(TestUnSupportedResourceTuningVerification, {
    std::string testResourceName = "/run/urm/tests/nodes/target_test_resource4.txt";
...
URM_TEST(ResourceOperationModeVerification, {
    std::string testResourceName = "/run/urm/tests/nodes/target_test_resource3.txt";
...
URM_TEST(SignalClientPermissionChecksVerification, {
    std::string testResourceName = "/run/urm/tests/nodes/sched_util_clamp_max.txt";
...
URM_TEST(SignalOutOfBoundsResourceTuning, {
    std::string testResourceName = "/run/urm/tests/nodes/sched_util_clamp_min.txt";
...
URM_TEST(SingleClientTuneRequestMultipleResources, {
    ...
    std::string testResourceName1 = "/run/urm/tests/nodes/scaling_max_freq.txt";
    std::string testResourceName2 = "/run/urm/tests/nodes/scaling_min_freq.txt";
    std::string testResourceName3 = "/run/urm/tests/nodes/sched_util_clamp_max.txt";
...
URM_TEST(TestMultipleClientsLazyApplyPolicy, {
    std::string testResourceName = "/run/urm/tests/nodes/target_test_resource5.txt";
...
URM_TEST(TestMultipleClientsTuneRequestDifferentResources, {
    ...
    std::string testResourceName2 = "/run/urm/tests/nodes/scaling_max_freq.txt";
    std::string testResourceName3 = "/run/urm/tests/nodes/sched_util_clamp_max.txt";
...
URM_TEST(TestClusterTypeResourceTuneRequest1, {
    ...
    std::string nodePath = "/run/urm/tests/nodes/cluster_type_resource_%d_cluster_id.txt";
...
URM_TEST(TestSingleClientTuneSignal2, {
    std::string testResourceName1 = "/run/urm/tests/nodes/sched_util_clamp_min.txt";
    std::string testResourceName2 = "/run/urm/tests/nodes/sched_util_clamp_max.txt";
    std::string testResourceName3 = "/run/urm/tests/nodes/scaling_max_freq.txt";
...
URM_TEST(TestSignalValidRetuning, {
    ResourceHolder testResources[] = {
        {
            .name = "/run/urm/tests/nodes/sched_util_clamp_min.txt",
            .expectedValue = 883,
            .originalValue = 300,
        },
        {
            .name = "/run/urm/tests/nodes/sched_util_clamp_max.txt",
            .expectedValue = 920,
            .originalValue = 684,
        },
        {
            .name = "/run/urm/tests/nodes/scaling_max_freq.txt",
            .expectedValue = 1555,
            .originalValue = 114,
        }
    };
...
URM_TEST(TestMultiResourceSignal, {
    ...
    std::string clusResource = "/run/urm/tests/nodes/cluster_type_resource_%d_cluster_id.txt";
    ...
    std::vector<ResourceHolder> tunedResources = {
        ...
        {
            .name = "/run/urm/tests/nodes/target_test_resource1.txt",
            .expectedValue = 231,
            .originalValue = -1
        },
        {
        ...
        {
            .name = "/run/urm/tests/nodes/target_test_resource4.txt",
            .expectedValue = 41128,
            .originalValue = -1
        },
    };
