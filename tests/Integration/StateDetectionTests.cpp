...
static void TestRequestSuspension() {
    ...
    std::string testResourceName1 = "/run/urm/tests/nodes/scaling_min_freq.txt";
    int32_t testResourceOriginalValue1 = 107;

    std::string testResourceName2 = "/run/urm/tests/nodes/sched_util_clamp_min.txt";
...
static void TestRequestRejectionInSuspendMode() {
    ...
    std::string testResourceName = "/run/urm/tests/nodes/scaling_max_freq.txt";
...
static void TestRequestResumptionPostResume() {
    ...
    std::string testResourceName = "/run/urm/tests/nodes/scaling_min_freq.txt";
